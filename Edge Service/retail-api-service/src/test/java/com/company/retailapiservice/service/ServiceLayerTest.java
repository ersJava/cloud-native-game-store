...
public class ServiceLayerTest {
    ...
    private void setUpInventoryClientMock() {
        ...
        doReturn(inventory).when(inventoryClient).getInventory(100);
...
//        invoiceItem.setInvoiceItemId(90);
...
//        invoiceItem1.setInvoiceId(11);
//        invoiceItem1.setInventoryId(100);
//        invoiceItem1.setQuantity(5);
//        invoiceItem1.setUnitPrice(new BigDecimal("22.99"));

//        List<InvoiceItemViewModel> items1 = new ArrayList<>();
//        items1.add(invoiceItem1);
//
//        invoice1.setItemList(items1);
...
//        // Mock createItem
//        doReturn(invoiceItem).when(invoiceClient).createItem(invoiceItem1);

//        // Mock getItem by Id
//        doReturn(invoiceItem).when(invoiceClient).get
...
//        InvoiceItemViewModel invoiceItem1 = new InvoiceItemViewModel();
//        invoiceItem1.setInvoiceItemId(90);
//        invoiceItem1.setInvoiceId(11);
//        invoiceItem1.setInventoryId(100);
//        invoiceItem1.setQuantity(5);
//        invoiceItem1.setUnitPrice(new BigDecimal("22.99"));
...
//        invoice1.setItemList(items1);
        ...
        invoice1 = invoiceClient.createInvoice(invoice1);

        InvoiceViewModel fromClient = invoiceClient.getInvoice(invoice1.getInvoiceId());

        assertEquals(fromClient, invoice1);
